...
function Cardspage() {
  ...
  return (
    <div className='relative flex items-center justify-center flex-col'>
      ...
      <button className="absolute bottom-2 px-[20px] py-[10px] border-2 border-white bg-black text-white rounded-[10px] text-[18px] font-light flex gap-2 cursor-pointer lg:right-[9%] right-[5%]" onClick={() => navigate("/allcourses")}>
        View all Courses
